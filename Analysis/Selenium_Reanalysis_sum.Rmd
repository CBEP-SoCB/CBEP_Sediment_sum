---
title: "Trend Analysis for Metals -- Digging into Selenium"
...
metals_data %>%
  ...
  theme(axis.text.x = element_text(angle = 45))
```
Non-detects only occurred in the 2010s era, and they have an effect on the
slope of the trend over time.  

So any trend in selenium depends on how one handles the 
...
observations and many more non-detects.  That tends to emphasize the difficulty
of making sense of the selenium data, when analytic methods appear to have 
...
That makes BIG difference int erms of estimation of whether Regions differ or 
not.
